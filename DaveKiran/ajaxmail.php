...
if(trim($un)!="" && trim($msg)!="" && trim($su)!="" && trim($em)!="")
{
	...
	{
		$message="Hi Admin..<p>".$un." has sent a query having user number".$su."email id as ".$em."</p><p>Query is : ".$msg."</p>";
		$headers = "MIME-Version: 1.0" . "\r\n";
		$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
		$headers .= 'From: <contact@davekiran.com>' . "\r\n";

		if(mail('akshay.sadarangani@gmail.com','Query for Dave & Kiran\'s Wedding',$message,$headers ))
		{
